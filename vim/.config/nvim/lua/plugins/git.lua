    ...
    config = function()
      ...
      require('gitsigns').setup {
        signs                        = {
          ...
          change       = { hl = 'GitSignsChange', text = icons.git.GitChange, numhl = 'GitSignsChangeNr', linehl = 'GitSignsChangeLn' },
          delete       = { hl = 'GitSignsDelete', text = icons.git.GitDelete, numhl = 'GitSignsDeleteNr', linehl = 'GitSignsDeleteLn' },
          topdelete    = { hl = 'GitSignsDelete', text = icons.git.GitTopDelete, numhl = 'GitSignsDeleteNr', linehl = 'GitSignsDeleteLn' },
          changedelete = { hl = 'GitSignsChange', text = icons.git.GitChangeDelete, numhl = 'GitSignsChangeNr', linehl = 'GitSignsChangeLn' },
        },
