...
cmp.setup({
  ...
  completion = {
    ...
    -- If false, you must press <Tab> to show the comletion window
    -- TODO: Could be super annoying not to see it (double with what Goland does)
    autocomplete = false,
  },
  window = {
  ...
  mapping = {
    ...
    -- use cmp completion window rather than nvim native window using <c-n>
    -- TODO: add the same mapping for <c-p>. Only if we actually use this completion
    ["<C-n>"] = cmp.mapping({
      i = function()
