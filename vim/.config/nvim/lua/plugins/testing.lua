...
function DAP.configure_debuggers()
  -- require("config.dap.lua").setup()
  require('dap-go').setup()
end

function DAP.setup_keymaps()
...
function DAP.setup()
  DAP.configure()           -- Configuration
  DAP.configure_exts()      -- Extensions
  DAP.configure_debuggers() -- Debugger
  DAP.setup_keymaps()
end
