...
M.nnoremap("<c-u>", "", { desc = "Disable <c-u> builtin mapping" })
M.nnoremap("]]", '<cmd>call search("^func")<cr>', { desc = "Jump to next func" })
M.nnoremap("[[", ':call search("^func", "b")<cr>', { desc = "Jump to prev func" })
M.nnoremap("<leader>bn", "<cmd>bn<cr>", { desc = "Buffer: Go to next" })
M.nnoremap("<leader>bp", "<cmd>bp<cr>", { desc = "Buffer: Go to prev" })
